...
def main(fname_out, fname_est, n_iter0, n_iter1):
    ...
    for i in range(100):
        ...
        if id in ids_estimated:
            ...
            state_lower[0] = state[0] - sigmas[0]/2
            state_lower[1] = state[1] - sigmas[1]/2
            state_lower[2] = state[2] - sigmas[2]*0.75
            state_lower[3] = state[3] - sigmas[3]/2
            state_lower[4] = state[4] - sigmas[4]/2
            state_lower[5] = state[5] - sigmas[5]/4
